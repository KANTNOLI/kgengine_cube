...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:cn,depthTest:!1,depthWrite:!1})}function ma(){return new fn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ds(),fragmentShader:`
		...
		`,blending:cn,depthTest:!1,depthWrite:!1})}function _a(){return new fn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ds(),fragmentShader:`
...
#define LOW_PRECISION`),e}function Zf(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Es?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Ia?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Yt&&(e="SHADOWMAP_TYPE_VSM"),e}function $f(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Jn:case Qn:e="ENVMAP_TYPE_CUBE";break;case Ji:e="ENVMAP_TYPE_CUBE_UV";break}return e}function jf(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Qn:e="ENVMAP_MODE_REFRACTION";break}return e}function Jf(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Na:e="ENVMAP_BLENDING_MULTIPLY";break;case Vo:e="ENVMAP_BLENDING_MIX";break;case Go:e="ENVMAP_BLENDING_ADD";break}return e}function Qf(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function ed(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Zf(t),c=$f(t),h=jf(t),f=Jf(t),d=Qf(t),m=Vf(t),v=Gf(s),M=r.createProgram();let p,u,b=t.glslVersion?"#version "+t.glslVersion+`
